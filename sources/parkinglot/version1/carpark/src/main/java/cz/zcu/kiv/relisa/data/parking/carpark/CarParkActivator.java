package cz.zcu.kiv.relisa.data.parking.carpark;
...
import cz.zcu.kiv.relisa.data.parking.carpark.flow.impl.VehicleFlow;
import cz.zcu.kiv.relisa.data.parking.carpark.status.IParkingStatus;
import cz.zcu.kiv.relisa.data.parking.carpark.status.impl.ParkingStatus;
